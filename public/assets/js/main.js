...
!function() {
    ...
    !function() {
        ...
        e.forEach((e => {
            if (!e.controls && !e.dataset.trimStartUs && !e.dataset.trimEndUs)
                return;
            const r = {}
              , {maybeResetVideoProgress: a, videoStart: i} = function(e, n) {
                ...
                e.addEventListener("timeupdate", ( () => {
                    ...
                    let o;
                    null != i && n >= i - (t ? .25 : 0) ? e.loop || e.dataset.loop ? (o = a,
                    e.play()) : e.pause() : n < a && (o = a),
                    null != o && n !== o && (e.currentTime = o)
                }
                ));
                const l = () => {
                    var t;
                    isNaN(e.duration) || (null == i && (i = e.duration),
                    null === (t = n.updateDuration) || void 0 === t || t.call(n, a, i))
                }
                ;
                e.addEventListener("durationchange", l),
                e.addEventListener("loadedmetadata", l),
                l();
                return {
            ...
            !e.controls)
                return;
            let l = e;
            for (; null != l && null != l.parentElement && (l = l.parentElement,
            "100%" !== l.style.width || "100%" !== l.style.height || "svg" === l.tagName.toLowerCase()); )
                ;
            l.parentElement && "section" === l.parentElement.tagName.toLowerCase() && (l = l.parentElement);
            const {onResizeCallback: s} = function(e, n, t, o, r) {
                "relative" !== e.style.position && "absolute" !== e.style.position && (e.style.position = "relative");
                n.controls = !1;
                const {seekBar: a, updateDuration: i} = function(e) {
                ...
                const {playButton: l, playPause: s} = function(e, n) {
                    let t = !1;
                    const o = async o => {
                        if (!t) {
                            t = !0,
                ...
                ;
                n.addEventListener("play", u),
                n.addEventListener("pause", p),
                n.paused ? p() : u();
                const v = () => {
                    n.paused || (l.style.opacity = "1"),
                    a.style.opacity = "1"
                }
                  , m = () => {
                    n.paused || (l.style.opacity = "0"),
                    a.style.opacity = "0"
                }
                ;
                ...
                return {
                    onResizeCallback: () => {
                        ...
                        l.style.visibility = n ? "visible" : "hidden",
